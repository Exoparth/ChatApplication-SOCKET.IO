...
function Chat() {
    ...
    useEffect(() => {
        const handlePrivateMessage = (msg) => {
            // Prevent duplicates
            if (msg._id && messages.some(m => m._id === msg._id)) return;
